...
local rain_speed, storm_speed = 600, 220 -- In pixels per second.
...
local max_num_drops_rain, max_num_drops_storm = 30, 250
...
--Max addition this next line
  rain_surface:set_blend_mode("blend")
  rain_surface:set_opacity(80)
