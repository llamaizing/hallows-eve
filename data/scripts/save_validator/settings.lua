...
local ALLOWED_TYPES = {"boolean", "number", "string"} --only these types are valid value types in saved settings values
...
function settings:load()
	...
	if sol.file.exists(FILE_NAME) then
		...
		for k,v in pairs(INITIAL_SETTINGS) do data[k]=v end --copy initial settings
